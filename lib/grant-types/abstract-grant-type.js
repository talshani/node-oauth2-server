...
AbstractGrantType.prototype.generateAccessToken = function(user, client, scope) {
  if (this.model.generateAccessToken) {
    return Promise.try(this.model.generateAccessToken, [user, client, scope]);
  }
...
AbstractGrantType.prototype.generateRefreshToken = function(user, client, scope) {
  if (this.model.generateRefreshToken) {
    return Promise.try(this.model.generateRefreshToken, [user, client, scope]);
  }
